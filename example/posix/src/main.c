...
int main()
{
    ...
    for (;;)
    {
        ...
        if (Callbacks_get_millis_cb() - prevPubMillis > 5000)
        {
            ...
            printf("SENDING A\n");
            res = tracklePublish(trackle_s, "a", "ciao da me", 30, PRIVATE, WITH_ACK, msg_key);
            printf("RES %d\n", res);
            res = tracklePublish(trackle_s, "b", message1, 30, PRIVATE, WITH_ACK, msg_key);
            printf("RES %d\n", res);
            /*res = tracklePublish(trackle_s, "c", message1, 30, PRIVATE, WITH_ACK, msg_key);
            printf("RES %d\n", res);
            res = tracklePublish(trackle_s, "d", message1, 30, PRIVATE, WITH_ACK, msg_key);
            printf("RES %d\n", res);
            res = tracklePublish(trackle_s, "e", message1, 30, PRIVATE, WITH_ACK, msg_key);
            printf("RES %d\n", res);*/
