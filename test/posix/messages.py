...
RECONNECT_RESULT = QueueMessage("reconnect_result", "Couldn't receive reconnect result from device simulator process within %d seconds.")
CONNECTED = QueueMessage("connected", "Device simulation process didn't connect to cloud within %d seconds.") #
DISCONNECTED = QueueMessage("disconnected", "Device simulation process didn't disconnect from cloud within %d seconds.")
...
DISCONNECT = QueueMessage("disconnect")
RECONNECT = QueueMessage("reconnect")
...
INJECT_UDP_PACKET = QueueMessage("inject_udp_packet")
UDP_PACKET_INJECTED = QueueMessage("udp_packet_injected",
                                   "Couldn't receive confirmation that malformed UDP packet was injected within %d seconds.")
